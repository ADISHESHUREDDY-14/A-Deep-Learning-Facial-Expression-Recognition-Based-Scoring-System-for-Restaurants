...
main = tkinter.Tk()
main.title("Design of  Facial Expression Recognition System using Deep Learning Model Based on Human Emotions Through Classification with CNN & RNN algorithm") #designing main screen
...
font = ('times', 13, 'bold')
title = Label(main, text='Design of  Facial Expression Recognition System using Deep Learning Model Based on Human Emotions Through Classification with CNN & RNN algorithm')
